...
-	Five model estimator (Pooled OLS, Fixed Effects, Fixed Effects (Two-Way), Random Effects (GLS) and First Difference)
- ⚡ No-code interface. Only Upload CSV/Excel datasets
