...
if not st.session_state.access_granted:
    ...
    with right_col:
        # ── Pricing cards ─────────────────────────────────────────────────────
        # Note: Streamlit sanitizes <a> wrapping block elements, so we use
        # div + onclick + cursor:pointer instead.
        st.markdown("""
        <div class="pricing-section fi d3" style="padding-top: 60px;">
          <div class="section-eyebrow">Pay-As-You-Go Credits · No Subscription</div>
          <div class="pricing-grid">

            <div class="price-card" onclick="window.open('https://flutterwave.com/pay/j5m67hrqr4iq','_blank')" style="cursor:pointer;">
              ...
              <div class="price-cta cta-secondary">Get Started →</div>
            </div>

            <div class="price-card featured" onclick="window.open('https://flutterwave.com/pay/txyljcuqfsel','_blank')" style="cursor:pointer;">
              ...
              <div class="price-cta cta-primary">Buy Credits →</div>
            </div>

            <div class="price-card" onclick="window.open('https://flutterwave.com/pay/yw7k3gmyjoud','_blank')" style="cursor:pointer;">
              ...
              <div class="price-cta cta-secondary">Buy Credits →</div>
            </div>
