...
<div style="font-family: monospace;">
    ...
    <!-- Header -->
    <div style="text-align:center; font-size:0.7rem; color:#4a5568; line-height:1.6;">
        Access is license-controlled.<br>
        Choose a plan below to unlock full features.
    </div>

    <div style="margin-top:16px; text-align:center; font-size:0.6rem;
    ...
    <div style="margin-top:12px; background:rgba(255,255,255,0.02);
        ...
        <div>
            <div style="font-weight:700; font-size:0.85rem; color:#e2e8f4;">
                Starter
            </div>
            <div style="font-size:0.65rem; color:#6b7a9a;">
                10 econometric analyses
            </div>
        </div>

        <div style="text-align:right;">
            <div style="font-weight:800; color:#00e5c8;">
                ₦2,500
            </div>
            <a href="FLUTTERWAVE_LINK_STARTER" target="_blank"
               style="font-size:0.65rem; color:#00e5c8; text-decoration:none;">
               Pay →
            </a>
        </div>
    </div>
    ...
    <!-- Standard -->
    <div style="margin-top:10px; background:rgba(0,229,200,0.04);
                border:1px solid rgba(0,229,200,0.2);
                border-radius:10px; padding:14px;
                display:flex; justify-content:space-between; align-items:center;
                position:relative;">
        ...
        <div>
            <div style="font-weight:700; font-size:0.85rem; color:#e2e8f4;">
                Standard <span style="font-size:0.55rem; color:#00e5c8;">POPULAR</span>
            </div>
            <div style="font-size:0.65rem; color:#6b7a9a;">
    ...
    <!-- Pro -->
    <div style="margin-top:10px; background:rgba(124,109,240,0.04);
        ...
        <div style="text-align:right;">
            <div style="font-weight:800; color:#7c6df0;">
                ₦15,000
            </div>
            <a href="FLUTTERWAVE_LINK_PRO" target="_blank"
               style="font-size:0.65rem; color:#7c6df0; text-decoration:none;">
               Pay →
            </a>
        </div>
    </div>
    ...
    <!-- Footer -->
    <div style="margin-top:12px; text-align:center; font-size:0.6rem; color:#4a5568;">
        Need help? 
        <a href="https://wa.me/2348096506034" target="_blank"
           style="color:#00e5c8; text-decoration:none;">
           Contact admin →
        </a>
    </div>
